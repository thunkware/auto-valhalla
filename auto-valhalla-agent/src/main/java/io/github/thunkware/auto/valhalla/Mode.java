...
public enum Mode {
    ...
    SAFE("safe"),
    /** Shorthand for the default {@code ignore-non-final,ignore-synchronized}.
     *  Never appears in a parsed set: {@link #parse(String)} expands it. */
    YOLO("yolo"),
    ...
    /** The default {@code mode} set when the option is not specified:
